...
class UserController extends Controller
{
    ...
    public function display(Request $request)
    {
        try {
            ...
            return view('main/users', ['users' => $users, 'sort_by' => $sort_by, 'sort_order' => $sort_order, 'search' => $search]);
    ...
    public function view($id)
    {
        try {
            ...
            return view('main/view-user', ['user' => $user, 'permissions' => $permissions]);
        } catch (AuthorizationException $e) {
            return redirect()->route('dashboard')->with('error', 'You do not have permission to perform this action.');
        }
    }
    public function create()
    {
        try {
            ...
            return view('main/add-user', compact('countryCodes'));
        } catch (AuthorizationException $e) {
            return redirect()->route('dashboard')->with('error', 'You do not have permission to perform this action.');
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('main.update-user', ['user' => $user, 'countryCodes' => $countryCodes, 'permissions' => $permissions]);
        } catch (AuthorizationException $e) {
            return redirect()->route('dashboard')->with('error', 'You do not have permission to perform this action.');
        }
    }
