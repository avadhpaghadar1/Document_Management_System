...
class DocumentTypeController extends Controller
{
    ...
    public function view(Request $request)
    {
        try {
            ...
            return view('documents/types/index', ['documentTypes' => $documentTypes, 'sort_by' => $sort_by, 'sort_order' => $sort_order, 'search' => $search]);
    ...
    public function edit(Request $request, $id)
    {
        try {
            ...
            return view('documents/types/edit', ['documentType' => $documentType]);
        } catch (AuthorizationException $e) {
            return redirect()->route('dashboard')->with('error', 'You do not have permission to perform this action.');
        }
    }
