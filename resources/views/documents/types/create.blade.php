...
<div class="container-fluid">
    <div class="row ">
        <div class="col-12 d-flex justify-content-between">
            ...
            <div>
                <p><i class="mb-1" data-feather="home"></i><span class="mx-1">Home</span><span><i data-feather="chevron-right"></i></span><span>Document Types</span><span><i data-feather="chevron-right"></i></span><span>@yield('title')</span></p>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="m-sm-3">
                        <form id="document-form" method="POST" action="add-document-type">
                            @csrf
                            <div class="row">
                                <div class="col-6 d-flex flex-column">
                                    <div class="mb-3">
                                        <x-input-label for="document_type" :value="__('Name')" />
                                        <x-input name="name" id="document_type" class="{{ $errors->has('name') ? 'is-invalid' : '' }}" :value="old('name')" placeholder="Document Type Name" />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="input-group ms-2 w-75">
                                                <x-input type="text" id="field-name" name="field-name" placeholder="Name" />
